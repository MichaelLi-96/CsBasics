...
public class QueueExample {
    ...
    public static void main(String[] args) {
        // Creating an Queue of Integers using a LinkedList
        Queue<Integer> myQueue = new LinkedList<>();

        // Adding new elements into myQueue
        myQueue.add("76");
        myQueue.add("48");
        myQueue.add("10");
        myQueue.add("32");

        // Removing the front most or least recent element of myQueue
		...
		return(
			<div className="content">
				...
				<div className="text-left"> 
					...
					<br />
					<br />				
					Being an interface, a queue does not have its own concrete class for declaration. The most commonly used is the LinkedList implementation of 
					a queue. To initialize a new queue of Integers, you would write:
					<SyntaxHighlighter language="java" showLineNumbers style={androidstudio} className="code-text">
						{initalizeQueue}
					</SyntaxHighlighter>
					<br />
					In Java, queues already have built in methods to do common functions which can be 
